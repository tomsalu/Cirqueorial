...
@interface UserSearchTableController ()

@end

@implementation UserSearchTableController


@synthesize usernameSearch;
...
- (PFQuery *)queryForTable{
    ...
    [userQ whereKey:@"username" equalTo:usernameSearch];
